...
{{-- <a href="reservation.html" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
    ...
    <section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url({{ asset('public/frontend/images/bg-title-page-02.jpg')}});">
    ...
    <img src="{{ asset('public/frontend/images/photo-gallery-13.jpg')}}" alt="IMG-GALLERY">
    ...
    <img src="{{ asset('public/frontend/images/photo-gallery-14.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <img src="{{ asset('public/frontend/images/photo-gallery-15.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
    <img src="{{ asset('public/frontend/images/photo-gallery-16.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
    <img src="{{ asset('public/frontend/images/photo-gallery-17.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <img src="{{ asset('public/frontend/images/photo-gallery-18.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <img src="{{ asset('public/frontend/images/photo-gallery-19.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
    <img src="{{ asset('public/frontend/images/photo-gallery-20.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
    ...
    <div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
    <img src="{{ asset('public/frontend/images/photo-gallery-21.jpg')}}" alt="IMG-GALLERY">
    <div class="overlay-item-gallery trans-0-4 flex-c-m">
