                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{url('admin/event/add')}}" style="float: right" class="btn btn-primary">Add New +</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($data as $list)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('admin/event/update')}}/{{$list->id}}" title="Edit">
                                                <img src="{{asset('public/backend/icon/edit.png')}}" alt=""></a>&nbsp;&nbsp;

                                                <a href="{{url('admin/event/delete')}}/{{$list->id}}" title="Delete">
